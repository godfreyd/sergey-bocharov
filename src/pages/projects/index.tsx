  ...
  return (
    <BaseLayout>
      ...
      <Section>
        <ol>
          <li>
            <Link target="_blank" href="https://www.npmjs.com/package/colibri-ui">
              <code>colibri-ui</code>
            </Link>
            <p>
              React UI components library.{' '}
              <Link target="_blank" href="https://godfreyd.github.io/colibri-ui/?path=/story/ui-badge--default">
                Demo
              </Link>
              .
            </p>
