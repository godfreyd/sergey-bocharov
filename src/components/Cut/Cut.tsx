...
export class Cut extends React.PureComponent<ICutProps> {
    ...
    render() {
        ...
        if (!visible) {
            return (
                <div
                    className={cnCut({ breakWords, oneLine }, [className])}
        ...
        return (
            <div
                ...
                onClick={this.tryOpenClickableContent}
            >
    ...
    renderHideLink() {
        ...
        return (
            <span className={cnCut('Hide')}>
                <span className={cnCut('Link')} onClick={this.close}>
                    {` ${hide}`}
                </span>
            </span>
        );
    ...
    renderMoreLink() {
        ...
        const type =
            typeof this.props.visible === 'string' ? 'text' : 'content';
        let moreContent: ICutProps['more'] = ' More';
        ...
        return (
            <Component className={cnCut('More', { type })}>
                <span className={cnCut('Link')} onClick={this.open}>
                    {moreContent}
                </span>
            </Component>
        );
