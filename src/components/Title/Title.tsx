...
export const Title: FC<ITitleProps> = ({ children, tag, className, style, innerRef, controlRef, ...props }) => {
  const Wrapper = tag || 'div';
  return (
    <Wrapper style={style} {...props} className={cnTitle({ tag }, [className])} ref={innerRef || controlRef}>
      {children}
    </Wrapper>
  );
};
